        ...
        <Element className="contact" id="contact" name="contact">
            ...
            <div className="my-12 md:my-20 pb-5 px-7 gap-4">
                ...
                <div className="md:flex">
                    <div className="max-w-md md:flex-1 py-4 px-8 bg-white dark:bg-gray-900 shadow-md rounded-lg mx-3 my-7">
                    ...
                    <div className="max-w-md md:flex-1 py-4 px-8 bg-white dark:bg-gray-900 shadow rounded-lg mx-3 my-7">
